import { Box, Divider, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, Tooltip, Typography } from "@mui/material";
import React, { useState } from "react";
import ArrowDropUpTwoToneIcon from '@mui/icons-material/ArrowDropUpTwoTone';
import ArrowDropDownTwoToneIcon from '@mui/icons-material/ArrowDropDownTwoTone';
import { makeStyles } from "@material-ui/core";
const columns = [
    { id: 'name', label: 'Name', minWidth: 170 ,option:{order:true}},
...
const Users = ()=>{
  ...
  const handleChangeRowsPerPage = (event) => {
    ...
    return(
        ...
        <Typography variant="h6" marginLeft={1} color="#fff" fontWeight={"bold"}>Users Listing</Typography>
       </Box>
